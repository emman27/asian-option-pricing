...
class AsianNewFloatCall(FloatingCall):
    def __init__(self, maxt, numx, numt, r, sigma, initial_price, old_average, t0):
        ...
        self.maxx = 2 # abs(self.xi_initial * 3)
...
if __name__ == "__main__":
    ...
    t0 = 0.1
    print('Expected: 9.85, Actual: ' + str(AsianNewFloatCall(maxt - t0, numx, numt, r, sigma, s0, 90, t0).solve()))
    print('Expected: 9.34, Actual: ' + str(AsianNewFloatCall(maxt - t0, numx, numt, r, sigma, s0, 100, t0).solve()))
    print('Expected: 8.84, Actual: ' + str(AsianNewFloatCall(maxt - t0, numx, numt, r, sigma, s0, 110, t0).solve()))

    t0 = 0.3
    print('Expected: 10.70, Actual: ' + str(AsianNewFloatCall(maxt - t0, numx, numt, r, sigma, s0, 90, t0).solve()))
    print('Expected: 9.05, Actual: ' + str(AsianNewFloatCall(maxt - t0, numx, numt, r, sigma, s0, 100, t0).solve()))
    print('Expected: 7.61, Actual: ' + str(AsianNewFloatCall(maxt - t0, numx, numt, r, sigma, s0, 110, t0).solve()))

    t0 = 0.9
    print('Expected: 10.38, Actual: ' + str(AsianNewFloatCall(maxt - t0, numx, numt, r, sigma, s0, 90, t0).solve()))
    print('Expected: 4.07, Actual: ' + str(AsianNewFloatCall(maxt - t0, numx, numt, r, sigma, s0, 100, t0).solve()))
    print('Expected: 1.03, Actual: ' + str(AsianNewFloatCall(maxt - t0, numx, numt, r, sigma, s0, 110, t0).solve()))
